...
const PENDING_TTL_MS = 5 * 60 * 1000;       // 5m  — mid-login state only
 ...
 *  granting access. `purpose` is 'mfa' or 'forceChange'; `data` carries any
 *  small extra state the next step needs (e.g. which MFA type to prompt for). */
